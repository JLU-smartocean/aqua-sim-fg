...
void
AquaSimHeader::SetPacketMode(uint8_t packetMode)
{
  m_packetMode = packetMode;
}
...
AquaSimPacketStamp::AquaSimPacketStamp() :
  ...
  m_freq(-1), m_noise(0), m_status(RECEPTION)
{
  bandWidth = 0;
  bandId = 0;
  bandNum = 1;
...
AquaSimPacketStamp::Deserialize(Buffer::Iterator start)
{
  ...
  bandWidth = (double) i.ReadU32() / 1000.0;
  bandId = i.ReadU8();
  bandNum = i.ReadU8();
...
AquaSimPacketStamp::Serialize(Buffer::Iterator start) const
{
  ...
  i.WriteU32((uint32_t)(bandWidth * 1000.0));
  i.WriteU8(bandId);
  i.WriteU8(bandNum);
}
...
double
AquaSimPacketStamp::GetBandWidth()
{
  return bandWidth;
}
uint8_t
AquaSimPacketStamp::GetBandId()
{
  return bandId;
}
...
void
AquaSimPacketStamp::SetBandWidth(double bandWidth)
{
  this->bandWidth = bandWidth;
}
void
AquaSimPacketStamp::SetBandId(uint8_t bandId)
{
  this->bandId = bandId;
}
void
AquaSimPacketStamp::SetBandNum(uint8_t bandNum)
{
