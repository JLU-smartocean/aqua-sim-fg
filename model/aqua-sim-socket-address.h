 ...
 */
#ifndef AQUA_SIM_SOCKET_ADDRESS_H
#define AQUA_SIM_SOCKET_ADDRESS_H
...
public:
   ...
   */
  Address GetDestinationAddress (void) const;
   ...
   */
  static AquaSimSocketAddress ConvertFrom (const Address &address);
...
#endif /* AQUA_SIM_SOCKET_ADDRESS_H */
