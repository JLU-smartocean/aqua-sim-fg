...
#ifndef ONOFF_ND_APPLICATION_H
#define ONOFF_ND_APPLICATION_H
 ...
 * \defgroup onoff nd OnOffNDApplication
 *
...
*/
class OnOffNDApplication : public Application
{
public:
...
private:
  ...
  EventId         m_recvEvent;    //!< Event id of pending "send packet" event
...
private:
   ...
   */
  void ScheduleNextTx ();
  void ScheduleNextTx_sink ();
  /**
   * \brief Schedule the next On period start
   */
  void ScheduleStartEvent ();
  void ScheduleStartEvent_sink ();
  /**
   * \brief Schedule the next Off period start
   */
  void ScheduleStopEvent ();
  void ScheduleStopEvent_sink ();
  /**
  ...
  /**
   * \brief Get the next interest to be assigned to packet payload.
   */
};

} // namespace ns3

#endif /* ONOFF_ND_APPLICATION_H */
