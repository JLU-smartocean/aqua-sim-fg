...
AquaSimEnergyModel::AquaSimEnergyModel() : m_energy(10000.0),
...
void AquaSimEnergyModel::SetDevice(Ptr<AquaSimNetDevice> device)
{
	m_device = device;
}
...
void AquaSimEnergyModel::ChangeState(int newState)
{
	NS_LOG_FUNCTION(this << newState);
}


void AquaSimEnergyModel::HandleEnergyChanged(){
	//todo
}
...
void AquaSimEnergyModel::HandleEnergyDepletion(void)
{
	NS_LOG_FUNCTION(this);
...
void AquaSimEnergyModel::HandleEnergyRecharged(void)
{
	// Not currently used.
}
...
void AquaSimEnergyModel::SetEnergySource(Ptr<EnergySource> source)
{
	NS_LOG_FUNCTION(this);
	NS_ASSERT(source != 0);
...
void AquaSimEnergyModel::SetRxPower(double rxP)
{
	m_rxP = rxP;
}
void AquaSimEnergyModel::SetTxPower(double txP)
{
	m_txP = txP;
}
void AquaSimEnergyModel::SetIdlePower(double idleP)
{
	m_idleP = idleP;
}
void AquaSimEnergyModel::SetEnergy(double energy)
{
	m_energy = energy;
}
void AquaSimEnergyModel::SetInitialEnergy(double initialEnergy)
{
...
void AquaSimEnergyModel::DecrIdleEnergy(double t, double idleP)
{
	NS_LOG_FUNCTION(this);
...
void AquaSimEnergyModel::DecrRcvEnergy(double t, double rcv)
{
	NS_LOG_FUNCTION(this);
	...
	m_totalEnergyConsumption += dEng;
	NS_LOG_DEBUG("ENERGY-" << AquaSimAddress::ConvertFrom(m_device->GetAddress())
						   << " totalComsume:" << m_totalEnergyConsumption
						   << " time:" << Simulator::Now().GetSeconds());
}

void AquaSimEnergyModel::DecrTxEnergy(double t, double pT)
{
	NS_LOG_FUNCTION(this);
...
void AquaSimEnergyModel::DecrEnergy(double t, double decrEnergy)
{
	NS_LOG_FUNCTION(this);
...
void AquaSimEnergyModel::DoDispose()
{
	NS_LOG_FUNCTION(this);
	m_device = 0;
	m_source = 0;
